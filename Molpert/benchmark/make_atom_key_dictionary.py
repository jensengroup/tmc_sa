...
from molecular_constraints import AtomKeyDictionary, LocalAtomKey, RingAwareAtomKey
...
def ParseArgs():
    ...
    parser.add_argument("output", type=str, help="Path to output atom key dictionary.")
    parser.add_argument(
        "-t",
        "--atom_key_type",
        type=str,
