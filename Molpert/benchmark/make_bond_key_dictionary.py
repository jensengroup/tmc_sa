...
from molecular_constraints import BondKeyDictionary, LocalBondKey, RingAwareBondKey
...
def ParseArgs():
    ...
    parser.add_argument("input", type=str, help="Path to input SMILES file.")
    parser.add_argument("output", type=str, help="Path to output bond key dictionary.")
    parser.add_argument(
        "-t",
        "--bond_key_type",
        type=str,
        choices=["local", "ring_aware"],
        default="local",
        help="Bond key type.",
    )
